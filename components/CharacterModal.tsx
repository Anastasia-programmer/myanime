...
export default function CharacterModal({ character, isOpen, onClose }: CharacterModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-9999" style={{ top: 0, left: 0, right: 0, bottom: 0 }}>
      ...
      <div
        className="absolute inset-0 bg-linear-to-br from-black/75 via-black/85 to-black/75 pointer-events-none"
        style={{
          top: 0,
          left: 0,
          right: 0,
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 md:p-10 overflow-y-auto pointer-events-none" style={{ zIndex: 10000 }}>
        ...
        <div className="relative w-full max-w-5xl max-h-[90vh] my-auto bg-linear-to-br from-[#020617] via-[#0a1120] to-[#020617] rounded-3xl border border-white/20 shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in zoom-in-95 duration-300 backdrop-blur-2xl pointer-events-auto">

          {/* Glowing border effect */}
          <div className="absolute inset-0 rounded-3xl bg-linear-to-r from-blue-500/20 via-purple-500/20 to-blue-500/20 opacity-50 blur-xl pointer-events-none" />

          {/* Left Side: Enhanced Character Image */}
          <div className="relative w-full md:w-96 h-72 md:h-auto bg-linear-to-br from-slate-900 to-slate-950 overflow-hidden shrink-0">
            <Image
            ...
            <div className="absolute inset-0 bg-linear-to-t from-[#020617] via-[#020617]/60 to-transparent md:bg-linear-to-r md:from-[#020617] md:via-[#020617]/80 md:to-transparent" />
          ...
          <div className="flex-1 flex flex-col overflow-hidden bg-linear-to-br from-[#020617]/95 to-[#0a1120]/95 backdrop-blur-sm min-w-0">
            {/* Header */}
            <div className="p-6 md:p-8 pb-0 flex justify-between items-start relative shrink-0">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter italic uppercase leading-none mb-2 bg-linear-to-r from-white via-white to-blue-200 bg-clip-text ">
                  {character.name}
                </h2>
              </div>
              <button
                onClick={onClose}
                className="relative z-10 p-2.5 hover:bg-white/10 rounded-full transition-all text-white/60 hover:text-white hover:scale-110 border border-white/10 hover:border-white/30 shrink-0"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="p-6 md:p-8 pt-6 overflow-y-auto custom-scrollbar flex-1 min-h-0" style={{ maxHeight: 'calc(90vh - 180px)' }}>
              ...
              {stats.length > 0 && (
                <div className="grid grid-cols-2 gap-4 mb-8">
                  {stats.map((stat, i) => (
                    <div
                      key={i}
                      className="group relative bg-linear-to-br from-white/5 to-white/2 border border-white/10 p-4 rounded-xl hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 overflow-hidden h-24 flex flex-col"
                    >
                      {/* Subtle glow effect on hover */}
                      <div className="absolute inset-0 bg-linear-to-br from-blue-500/0 to-purple-500/0 group-hover:from-blue-500/10 group-hover:to-purple-500/5 transition-all duration-300 rounded-xl" />

                      <div className="relative z-10 flex flex-col h-full">
                        <div className="w-1 h-1 rounded-full bg-blue-500" />
                        <p className="text-[9px] uppercase tracking-widest text-blue-400/80 font-bold mb-2 flex items-center gap-1.5 shrink-0">
              ...
              <div className="space-y-4 relative">
                ...
                <div className="relative">
                  <div className="absolute -left-4 top-0 bottom-0 w-1 bg-linear-to-b from-blue-500/50 via-purple-500/30 to-transparent rounded-full" />
