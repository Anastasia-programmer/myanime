...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://otakumo.vercel.app'),
  ...
  openGraph: {
    ...
    images: [
      {
        // Full URL for OpenGraph image
        url: 'https://otakumo.vercel.app/im.png', 
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    // Full URL for Twitter card image
    images: ['https://otakumo.vercel.app/im.png'], 
  },
};
